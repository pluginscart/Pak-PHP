...
use Framework\Testing\BrowserApplicationTesting;
...
class Testing extends BrowserApplicationTesting
{
    ...
    public function TestAuthentication()
    {
        ...
        $authentication           = ApplicationConfiguration::GetComponent("authentication");
        /** 
    ...
    {
        $database_obj        = ApplicationConfiguration::GetComponent("database");
        ...
        $caching_obj         = ApplicationConfiguration::GetComponent("caching");
    ...
    public function TestEncryption()
    {
        ...
        $encryption_obj = ApplicationConfiguration::GetComponent("encryption");
    ...
    public function TestEmail()
    {
        ...
        $email_obj = ApplicationConfiguration::GetComponent("email");
    ...
    public function TestString()
    {
        ...
        $string_obj = ApplicationConfiguration::GetComponent("string");
