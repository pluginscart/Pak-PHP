...
{    
				...
				if (is_callable($application_callback))
					{
						...
						Configuration::SetConfig("application_url_mappings",$configuration['application_url_mappings']);
					}
    ...
    {        
        ...
        $application_url_mappings = Configuration::GetConfig('path','application_url_mappings');
    ...
    {        
        ...
        $default_configuration = Configuration::GetConfig("path","default_configuration");
