...
/**
 * Singleton class
 * Authentication class provides authentication related functions
 * 
 * It includes functions that provide authentication such as http digest authentication
 * 
 * @category   Framework
 * @package    Utilities
...
class Authentication
{
     ...
     * 
     * @since 1.0.0
     * @param array $credentials list of valid user credentials. it is an array of arrays with 2 keys:
     * user_name: user name
