...
class Configuration extends \Framework\Configuration\Configuration
{
    ...
    public function __construct($parameters)
    {
	    ...
	    $this->user_configuration['required_frameworks']['frameworkdatabase']['parameters'] = $database_parameters;
		...
		$this->user_configuration['required_frameworks']['logging']['class_name']           = '\Framework\Utilities\Logging';
		...
		$this->user_configuration['required_frameworks']['caching']['parameters']           = array("table_name"=>"cached_data","db_link"=>"");
